...
// Deliberately not the customer app's key: both run on localhost in
// development, and sharing storage would mean signing into one signs you into
// the other.
const STORAGE_KEY = 'romano-admin-auth';
