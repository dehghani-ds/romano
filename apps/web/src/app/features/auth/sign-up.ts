    ...
    <div class="container container--narrow page">
      <div class="card">
        ...
        <p class="muted text-sm intro">
          نام، نام کاربری و تیم شما را می‌خواهیم — تا بدانیم قهوه را کجا برسانیم.
        </p>
        ...
        <form [formGroup]="form" (ngSubmit)="submit()" class="stack" novalidate>
          ...
          <fieldset class="group">
            <legend class="eyebrow">راه ارتباطی و محل تحویل</legend>
            ...
            <div class="field">
              ...
              />
              <p class="field__hint">
                قهوه سر تیم شما تحویل داده می‌شود — مثلاً «تیم پلتفرم». بعداً هم می‌توانید عوضش کنید.
              </p>
              @if (invalid('teamName')) {
                <p class="field__error" role="alert">
                  <app-icon name="alert" [size]="14" />
